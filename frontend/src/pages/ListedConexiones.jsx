...
export default function ListedSchools() {
  ...
  useEffect(() => {
    ...
    try {
        setLoading(true);
        setError(null);
        const escuelaResponse= await fetch("http://localhost:5000/api/admin/conexiones", {
            headers: {
                'Authorization': `Bearer ${token}`,
  ...
  return (
    <div className="usuario-escuela-panel-container">
      ...
      <div className="user-profile-container">
        <h1>Información de las Conexiones</h1>
        ...
        {userData && userData.conexiones && userData.conexiones.length > 0 ? (
            ...
            <div className="info-section">
                ...
                <div key={index} className="documento-item" onClick={() => navigate(`/administrador/informacion/${documento.CCT}/Escuela`)}>
                    ...
                    {renderNonEditableField('Apoyo ', documento.apoyoNombre)}
