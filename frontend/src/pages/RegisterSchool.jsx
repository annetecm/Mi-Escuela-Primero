    ...
    return (
        <div className="register-container">
            <div className="image-section">
                    <img src={niñosImg} alt="Niños foto" />
            </div>
                ...
                <div className="scroll">
                    ...
                    <div className="heading">DATOS DE CONTACTO CON EL/LA SUPERVISOR/A</div>
                        ...
                        <div className="heading">DATOS DE LA ESCUELA CICLO 2024-2025</div>
                            ...
                            <div className="form-group">
                                <label>En los últimos dos ciclos escolares, ¿han recibido apoyo del Gobierno Municipal? Si sí, ¿qué instancia y qué apoyo?</label>
                                <input className="form-input" type="text"/>
                            </div>
                        </form>
